		...
		<div className="dashboard">
			...
			<main className="content">
				...
				<form onSubmit={handleSubmit(onSubmit)}>
					<div className="mb-3">
						<input type="text" className="form-control" {...register("origin", { required: "El origen es obligatorio", minLength: { value: 3, message: "Mínimo 3 caracteres" }})} placeholder="Origen" />
						{errors.origin && (
					...
					<div className="mb-3">
						<input type="text" className="form-control" {...register("destination", { required: "El destino  es obligatorio", minLength: { value: 3, message: "Mínimo 3 caracteres" }})} placeholder="Destino" />
						{errors.destination && (
							<p className="text-danger">
					...
					<div className="mb-3">
						<input type="text" className="form-control" {...register("client", { required: "El cliente  es obligatorio", minLength: { value: 3, message: "Mínimo 3 caracteres" }})} placeholder="Cliente" />
						{errors.client && (
							<p className="text-danger">
					...
					<div className="mb-3">
						<textarea type="text" className="form-control" {...register("description", { required: "La descripción es obligatoria", minLength: { value: 10, message: "Mínimo 10 caracteres" }})} placeholder="Descripción" />
						{errors.description && (
							<p className="text-danger">
